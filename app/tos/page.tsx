...
export default function TermsOfService() {
  return (
    <TemplatePage title='Terms of Service'>
      <h1 className='py-4'>OVERVIEW</h1>
      <p>
        This website is operated by FlipTrack. Throughout the site, the terms
        “we”, “us” and “our” refer to FlipTrack. FlipTrack offers this website,
      ...
      <h1 className='py-4'>SECTION 1 - ONLINE STORE TERMS</h1>
      <p>
      ...
      <h1 className='py-4'>SECTION 2 - GENERAL CONDITIONS</h1>
      <p>
      ...
      <h1 className='py-4'>SECTION 5 - PRODUCTS OR SERVICES (if applicable)</h1>
      <p>
      ...
      <h1 className='py-4'>SECTION 7 - OPTIONAL TOOLS</h1>
      <p>
      ...
      <h1 className='py-4'>SECTION 8 - THIRD-PARTY LINKS</h1>
      <p>
      ...
      <h1 className='py-4'>SECTION 10 - PERSONAL INFORMATION</h1>
      <p>
        Your submission of personal information through the store is governed by
        our Privacy Policy. To view our Privacy Policy, please visit [LINK TO
        PRIVACY POLICY]
      </p>

      <h1 className='py-4'>SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</h1>
      <p>
      ...
      <h1 className='py-4'>SECTION 12 - PROHIBITED USES</h1>
      <p>
      ...
      <p>
        ...
        non-infringement. In no case shall FlipTrack, our directors, officers,
      ...
      <h1 className='py-4'>SECTION 14 - INDEMNIFICATION</h1>
      <p>
        You agree to indemnify, defend and hold harmless FlipTrack and our
      ...
      <h1 className='py-4'>SECTION 15 - SEVERABILITY</h1>
      <p>
      ...
      <h1 className='py-4'>SECTION 16 - TERMINATION</h1>
      <p>
      ...
      <h1 className='py-4'>SECTION 17 - ENTIRE AGREEMENT</h1>
      <p>
      ...
      <h1 className='py-4'>SECTION 18 - GOVERNING LAW</h1>
      <p>
        These Terms of Service and any separate agreements whereby we provide
        you Services shall be governed by and construed in accordance with the
        laws of [insert address of Company].
      </p>

      <h1 className='py-4'>SECTION 19 - CHANGES TO TERMS OF SERVICE</h1>
      <p>
